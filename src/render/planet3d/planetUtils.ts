...
export const ENTITY_ALTITUDE = 0.005; // Higher offset to clear planet surface occlusion
export const CLOUD_ROTATION_SPEED = 0.3;  // Moderate cloud rotation speed for visible movement
